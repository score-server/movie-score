...
public class SeriesController {
    ...
    public SeriesController(SerieRepository serieRepository, GenreRepository genreRepository, CookieService cookieService, SearchService searchService, DuplicateService duplicateService) {
